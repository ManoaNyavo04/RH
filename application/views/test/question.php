      ...
      <div class="page-container">
          ...
          <div class="col-md-6">
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="<?php echo site_url("test_control/test/checkreponse/".$idservice) ; ?>" method="get">
                <?php foreach ($questrep[0]->result_array() as $question) { 
                  if ($question['idservice'] == $idservice) {?>
                  <div class="form-group">
                    <label for="validationCustom3"><?php echo $question['idquestion']." ".$question['question'];?></label>
                    
                    <?php foreach ($questrep[1]->result_array() as $reponse) { 
                        if ($reponse['idquestion']==$question['idquestion']) { ?>
                      <div class="form-check">
                          <input type="checkbox" name="reponse[]" value="<?php echo $question['idquestion'].",".$reponse['idreponse'];?>">
                          <label class="form-check-label" for="invalidCheck">
                            <?php 
                              if ($reponse['note'] != 0) { echo "MARINA    ".$reponse['reponse'];}
                              else { echo "DISO   ".$reponse['reponse'];}
                            ?>
                          </label>
                      </div>
                    <?php } } ?>
