            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                <li class="nav-item active">
                  <a class="nav-link pl-3" href="./index.html"><span class="ml-1 item-text">Liste des services</span></a>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">Liste service</h2>
              <div class="row my-4">
                <!-- Small table -->
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <?php for ($i=0; $i < count($service); $i++) { ?>
                          <tr>
                              <td>
                                <?php echo $service[$i]["nomservice"]; ?>
                              </td>
                              <td>
                                <?php echo $service[$i]["horaire"]; ?>
                              </td>
                              <td>
                                <a href="<?php echo site_url('index.php/Service_controller/test_mandefa/'.$service[$i]["idservice"]); ?>"><button type="button" class="btn mb-2 btn-info">Parcourir</button></a>
                              </td>
                          </tr>
                          <?php } ?>
                        </tbody>
